...
public class FuelSubsystem extends SubsystemBase {
  ...
  public Command intakeOnlyCommand() {
    return Commands.startEnd(() -> this.m_intakeMotor.set(Constants.FuelConstants.kIntakeSpeed), () -> this.m_intakeMotor.stopMotor(), this);
  }
