...
public class VisionSubsystem extends SubsystemBase {
  ...
  private LinearFilter m_XRFilter = LinearFilter.movingAverage(5);
  private LinearFilter m_YRFilter = LinearFilter.movingAverage(5);
  private LinearFilter m_RotRFilter = LinearFilter.movingAverage(5);
